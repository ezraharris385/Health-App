 ...
 * All data access goes through the helpers exported by routes/vitamins.ts so
 * agent writes follow the exact same validation as the HTTP API.
 */
import type { AgentDef } from "../framework";
import { todayStr, isValidDateStr } from "../../db";
import { getVitaminSummary } from "../../summaries";
import { NUTRIENT_KEYS, NUTRIENT_BY_KEY } from "../../../shared/nutrients";
import {
